...
const PropertyCard = ({ property }) => {
  ...
  return (
    <div className="rounded-xl shadow-md relative flex flex-col justify-between bg-blue-50 dark:bg-gray-800">
      <Image
      ...
      <div className="p-4">
        <div className="text-left md:text-center lg:text-left mb-6">
          <div className="text-gray-600 dark:text-white">{property.type}</div>
        ...
        <div className="flex justify-center gap-4 text-green-900 dark:text-white text-sm mb-4">
